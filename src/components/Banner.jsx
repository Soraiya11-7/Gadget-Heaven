    ...
    return (
        <div className='top-5 '>
            <div className="container w-[95%] mx-auto ">
                <div className="border-[7px] border-[#F6F6F6] outline-none bg-[#9538E2]  rounded-[32px] h-[650px] text-center">
                ...
                <div className='container bg-transparent mx-auto h-auto lg:h-[500px] w-[60%] overflow-hidden  mt-[-200px] transform  z-10 flex items-center justify-center border-[3px] border-white rounded-[32px] p-6'>
